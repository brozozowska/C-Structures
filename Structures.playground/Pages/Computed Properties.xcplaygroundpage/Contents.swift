 ...
 */
let song1 = Song(title: "Rockstar", artist: "Post Malone", duration: 134)
let song2 = Song(title: "Video games", artist: "Lana del Ray", duration: 194)
let song3 = Song(title: "Мозги", artist: "Комсомольск", duration: 118)

let songs: [Song] = [song1, song2, song3]

/* Declare the songInformation function here */
func informationFor (song: Song) -> String {
    return "\(song.formattedTitle), duration \(song.formattedDuration)"
}
